...
A public function with a documenation comment calls a private function, and
...
This syntax will be extended in future for assertions and other error messages.
