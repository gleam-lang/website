...
constructor with the same name as one of the items from the prelude, it would no
longer be possible to refer to the shadowed prelude one.
...
Now with v0.15.0 the prelude module can be imported under the name `gleam`,
enabling qualified use of shadowed items.
...
assertions like this, for example when prototyping or writing a quick script.
...
With this change Gleam's sponsorship will be my primary income. If you would
like to support me in making Gleam please consider [sponsoring
